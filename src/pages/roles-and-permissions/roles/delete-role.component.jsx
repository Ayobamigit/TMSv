...
export default function DeleteRole( { roleToBeDeleted }) {
                ...
                .then(result => {
                    ...
                    if(result.data.respCode === '00'){
                        Swal.fire({
                            ...
                            text: 'Role Deletion was Successful!'
                        })
    ...
    return (
        <div className="modal fade" id="deleteRoleModal" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLabel">Delete this Role</h5>
